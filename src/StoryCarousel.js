...
const StoryCarousel = () => {
  ...
  return (
    <div className='storyCarousel'>
      ...
      {screen <= 400 ? <NoahPFP Title="Designer & Developer" Text="My name is Noah I am a Graphic & UX Designer and self taught Junior Developer. I have recently discovered a love for building and creating apps. I am working toward becoming a Front End App Developer. I have experience with HTML, CSS, javascript and React." /> : null}
