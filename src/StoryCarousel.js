...
const StoryCarousel = () => {
  ...
  return (
    <div className='storyCarousel'>
      ...
      {screen > 400 ? <NoahPFP Title="Designer" Text="I've been designing alot longer than I've been developing. I graduated with a BA in Advertising and Graphic Design in 2019 but I had trouble finding passion and drive in just design. For that reason I did not dive into that career path. I took a couple years and have found my passion again. I love to design and build. I have found a ton of love for UX Design in the past year." /> : null}
      {screen <= 400 ? <NoahPFP Title="Design & Dev" Text="My name is Noah I am a Graphic & UX Designer and self taught Junior Developer. I have recently discovered a love for building and creating apps. I am working toward becoming a Front End App Developer. I have experience with HTML, CSS, javascript and React." /> : null}
      <div className='button__background greenDark customBttn'>
